#!/usr/bin/env bash
# Run the full grokking regularization experiment for the XOR task:
...
OUTPUTS_DIR="${SCRIPT_DIR}/outputs/xor"
DEVICE="${DEVICE:-cuda}"
NUM_SEEDS="${NUM_SEEDS:-10}"
PYTHON="${PYTHON:-python}"

echo "=== GrokAlign XOR Experiments ==="
echo "  Device   : ${DEVICE}"
...
run_condition "GrokAlign (λ=1.0)" --lambda_reg 1.0
run_condition "OrthoGrad"         --orthogonal_gradients

echo "=== XOR experiments complete ==="
echo ""
